...
public class E14 extends TestBase {
    ...
    public void placeOrderRegisterWhileCheckout(){
        ...
        //5. Click 'Cart' button
        driver.findElement(By.xpath("//p[@class='text-center']//a[.='View Cart']")).click();
        ...
        driver.findElement(By.xpath("//*[@*='signup-name']")).sendKeys("ronaldoo", Keys.TAB,"ronaldoo@gmail.com",Keys.ENTER);
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//*[text()='ronaldoo']")).isDisplayed());
