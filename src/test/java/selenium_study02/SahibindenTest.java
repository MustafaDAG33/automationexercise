...
public class SahibindenTest extends TestBase {
    ...
    public void test01() {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//*[@class='desktop win']")).isDisplayed());
        ...
        Assert.assertEquals("Detaylı Arama",driver.getTitle());
    ...
    public static void detayliAramaAdres(String il, String ilce, String mah){

        driver.findElement(By.xpath("//a[@class='faceted-select']")).click();
        driver.findElement(By.xpath("//li[@data-address='town']")).sendKeys(il);
